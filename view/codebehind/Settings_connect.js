...
function Load_Data_API(){
    ...
    $.ajax({
        ...
        success: function (data, status) {
            ...
            document.getElementById('Img_State_API').src = 'view/img/Check_Settings.svg';
        },

        error : function(data,status){
            console.log(status + '-> API');
            console.log(data);
            document.getElementById('Img_State_API').src = 'view/img/Wrong_Settings.svg';
        }
    });
    ...
    $.ajax({
        ...
        success: function (data, status) {
            if(data != 'OK')
            {
                ...
                document.getElementById('Img_state_RASP').src = 'view/img/Wrong_Settings.svg';
            }
            else
            {
                console.log("success-> Raspberry");
                document.getElementById('Img_state_RASP').src = 'view/img/Check_Settings.svg';
            }
            },
...
function Load_Data_BDD(){
    ...
    $.ajax({
        ...
        success: function (data, status) {
            ...
            document.getElementById('Img_state_BDD').src = 'view/img/Check_Settings.svg';
